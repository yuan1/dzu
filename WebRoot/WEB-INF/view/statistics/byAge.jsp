...
<body>
<%
	String agestr=request.getAttribute("agestr").toString();
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="St_ByAge" method="post" id="ftijao">
	<div class="searchBar">
		<%@include file="form.jsp" %>
	</div>
	</form>
</div>
  <div id="mainage" style="width: 100%; height:400px;"></div>
